$(document).ready(function () {
  $(".btn").on("click", function (e) {
    ...
    if (!emailRegex.test(mail)) {
      var i =
        "<p class='text-danger error mail'>mail nije unet u pravilnom formatu:kosta123@gmail.com</p>";
      $("#mail").after(i);
    }
    ...
    if (!telefonRegex.test(brojTelefona)) {
      var i =
        "<p class='text-danger error brojTelefona'>telefon nije unet u pravilnom formatu:060529697</p>";
  ...
  $("#mail").on("input", function () {
    // Ovaj kod će se izvršiti svaki put kada korisnik unese tekst u polje
    var mail = $("#mail").val();
    var mailRegex = /^\w{4,}@[a-zA-Z]+\.[a-zA-Z]{2,4}$/;
